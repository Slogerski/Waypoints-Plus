...
final class WaypointSettingsScreen extends Screen {
    ...
    @Override protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.literal(UiText.get("Language: English", "Język: polski")), b -> {
            ...
            markDirty();
            minecraft.setScreen(new WaypointSettingsScreen(parent, profileIndex, session));
    ...
    private void openProfile(int index, int size, String serverKey) {
        ...
        minecraft.setScreen(new WaypointSettingsScreen(parent, index, session));
    }
    ...
    private void openProfileEditor() {
        applyFields();
        minecraft.setScreen(new ProfileNameScreen(this, parent, profileName));
    }

    private void openAbout() {
        applyFields();
        minecraft.setScreen(new AboutScreen(this));
    }
    ...
    private void openTopDonate() {
        ...
        opened.refresh().thenAccept(snapshot -> minecraft.execute(() -> {
            if (minecraft.screen == this && topDonateSession == opened) topDonate = snapshot;
        }));
    }
