...
final class WaypointManagerScreen extends Screen {
    ...
    private void changePage(int targetPage) {
        selection.confirmSingleDelete = null;
        selection.confirmDelete = false;
        minecraft.setScreen(new WaypointManagerScreen(parent, targetPage, selection));
    }

    private void editWaypoint(Waypoint waypoint) {
        selection.confirmSingleDelete = null;
        selection.confirmDelete = false;
        minecraft.setScreen(new EditWaypointScreen(this, waypoint));
    }

    private void openSettings() {
        selection.confirmSingleDelete = null;
        selection.confirmDelete = false;
        minecraft.setScreen(new WaypointSettingsScreen(this));
    }
    ...
    private void cycleDimensionFilter() {
        ...
        selection.confirmSingleDelete = null;
        selection.confirmDelete = false;
        minecraft.setScreen(new WaypointManagerScreen(parent, 0, selection));
    }
