...
final class ColorPickerScreen extends Screen {
    ...
    private void resetColor() { onReset.run(); Minecraft.getInstance().setScreen(parent); }
    private void assign(Consumer<String> target) { target.accept(value()); Minecraft.getInstance().setScreen(parent); }
