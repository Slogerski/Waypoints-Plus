...
final class RemoteImageTexture implements AutoCloseable {
    ...
    private static final Identifier TEXTURE_ID = Identifier.of("waypointsplus", "dynamic/about_ad");
    ...
    private void install(NativeImage image, int imageWidth, int imageHeight, int request) {
        ...
        try {
            texture = new NativeImageBackedTexture(() -> "waypointsplus/about-ad", image);
