...
final class RemoteImageTexture implements AutoCloseable {
    ...
    private static final Identifier TEXTURE_ID = Identifier.fromNamespaceAndPath("waypointsplus", "dynamic/about_ad");
    ...
    private void install(NativeImage image, int imageWidth, int imageHeight, int request) {
        ...
        try {
            texture = new DynamicTexture(() -> "waypointsplus/about-ad", image);
